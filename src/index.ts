...
async function defaultAction(projectGlobPaths: string[], options: CleanerOptions): Promise<void> {
    try {
        ...
        for (const projectPath of projectPaths) {
            ...
            await cleanupSingleProject(projectPath, outputPath, editorBundle, editorBundleExtra, options.throw ?? false);
        }
    } catch (err) {
...
program
    ...
    .option('-t, --throw', `Enable throwing errors on unexpected conditions which can be normally ignored or skipped`)
